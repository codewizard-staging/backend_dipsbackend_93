package com.app.dipsbackend.integrationtest;
...
import com.app.dipsbackend.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("dipsbackend", n.getAttribute("Namespace"));
  ...
  void  testCreateOrganizationInstance() throws IOException {
    given()
        ...
        .when()
        .post("/dipsbackend/Organizations")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/dipsbackend/Organizations?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/dipsbackend/Organizations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/dipsbackend/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/dipsbackend/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/dipsbackend/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmlpoyeeProfileInstance() throws IOException {
    given()
        ...
        .when()
        .post("/dipsbackend/EmlpoyeeProfiles")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/dipsbackend/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/dipsbackend/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM dipsbackend.Organization");
    jdbcTemplate.execute("DELETE FROM dipsbackend.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM dipsbackend.EmlpoyeeProfile");
